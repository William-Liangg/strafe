...
import { Bot, Ticket, Users, Plug2 } from 'lucide-react'
    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-2 text-slate-500 hover:text-slate-300 transition-colors text-sm"
        >
